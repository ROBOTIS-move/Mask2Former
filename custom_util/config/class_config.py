...
class_info = {
    ...
    'pedestrian':          {'id': 21, 'category_id': Category.NONTARGET.value,     'color': [220, 20, 60],   'trainable': True},
    'traffic-sign':        {'id': 22, 'category_id': Category.CONSTRUCTION.value,  'color': [64, 0, 128],    'trainable': True},
    'traffic-light-front': {'id': 23, 'category_id': Category.CONSTRUCTION.value,  'color': [250, 170, 30],  'trainable': True},
    'traffic-light-back':  {'id': 24, 'category_id': Category.CONSTRUCTION.value,  'color': [153, 0, 255],   'trainable': True},
    'vehicle':             {'id': 25, 'category_id': Category.NONTARGET.value,     'color': [250, 200, 100], 'trainable': True},
    'fence':               {'id': 26, 'category_id': Category.CONSTRUCTION.value,  'color': [190, 153, 153], 'trainable': True},
    'dynamic':             {'id': 27, 'category_id': Category.NONTARGET.value,     'color': [150, 100, 255], 'trainable': True},
    'static':              {'id': 28, 'category_id': Category.CONSTRUCTION.value,  'color': [0, 128, 128],   'trainable': True},
    'forbidden-area':      {'id': 29, 'category_id': Category.FLAT.value,          'color': [255, 0, 0],     'trainable': False},
    'void':                {'id': 30, 'category_id': Category.CONSTRUCTION.value,   'color': [63, 63, 63],   'trainable': False},
